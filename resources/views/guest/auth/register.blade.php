        ...
        <div class="w-full space-y-8">
            <div class="bg-white rounded-lg shadow-md p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Silakan Daftar</p>
                </div>
                ...
                <form action="{{ route('guest.auth.register.submit') }}" method="POST" id="registerForm" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   class="block w-full pl-10 pr-3 py-3 border @error('name') border-red-300 @else border-gray-300 @enderror rounded-md placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                   id="name" 
                                   name="name" 
                                   value="{{ old('name') }}" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text"
                                   class="block w-full pl-10 pr-3 py-3 border @error('phone') border-red-300 @else border-gray-300 @enderror rounded-md placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" 
                                   id="phone" 
                                   name="phone" 
                                   value="{{ old('phone') }}" 
