    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <h1 class="text-2xl font-bold text-neutral-900">Tarik Dana</h1>
            </div>
        ...
        <div class="bg-primary-50 border border-primary-200 rounded-xl p-5 mb-6 shadow-sm">
            <div class="flex justify-between items-center">
                ...
                <span class="text-lg font-bold text-primary-900">{{ $wallet->formatted_available_balance }}</span>
            </div>
        </div>
                    ...
                    <div class="text-right">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                            {{ $request->status->color() === 'success' ? 'bg-success-100 text-success-700' :
                               ...
                               ($request->status->color() === 'info' ? 'bg-info-100 text-info-700' :
                               ($request->status->color() === 'danger' ? 'bg-error-100 text-error-700' : 'bg-secondary-100 text-secondary-700'))) }}">
        ...
        <!-- Withdraw Form -->
        <form action="{{ route('seller.wallet.withdraw.submit') }}" method="POST"
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-neutral-500 mt-1">Minimum Rp 50.000 - Maksimum {{ $wallet->formatted_available_balance }}</p>
                @error('amount')
