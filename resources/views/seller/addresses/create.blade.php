{{-- resources/views/seller/addresses/create.blade.php --}}
<x-layouts.plain-app>
    <x-slot name="title">Tambah Alamat</x-slot>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('seller.addresses.store') }}" class="space-y-6"
              x-data="addressForm()" x-init="initGoogleMaps()">
            @csrf
