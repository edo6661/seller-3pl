<x-layouts.plain-app>
    <x-slot name="title">Edit Anggota Tim</x-slot>
    
    <div class="bg-gray-50 py-12">
        <div class="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <form action="{{ route('seller.team.update', $teamMember->id) }}" method="POST" x-data="teamEditForm()">
                @csrf
                @method('PUT')
                <input type="hidden" name="user_id" value="{{ $teamMember->user_id }}">
                
                <div class="overflow-hidden rounded-lg bg-white shadow-md">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Anggota Tim</h3>
                        <p class="mt-1 max-w-5xl text-sm text-gray-500">
                            Perbarui informasi dan hak akses anggota tim.
                        </p>
                    </div>
                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <p class="mt-1 text-xs text-gray-500">Nonaktifkan untuk mencabut sementara akses anggota tim ini</p>
                            </div>
                        </div>
                    </div>
                    
                    {{-- Permissions Section (sama seperti create form) --}}
                    <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
