{{-- resources/views/components/shared/chat-widget.blade.php --}}
<div x-data="chatWidget()" 
    ...
    <div x-show="!isExpanded" 
        ...
        <!-- Pulse indicator untuk pesan baru -->
    ...
    <div x-show="isExpanded" 
        ...
        <div class="bg-primary-600 text-white p-4 rounded-t-lg flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <!-- Back button ketika di conversation view -->
        ...
        <div class="flex-1 overflow-hidden">
            ...
            <div x-show="currentView === 'conversations'" class="h-full flex flex-col">
                ...
                <!-- Start Chat Button (untuk seller) -->
            ...
            <!-- Conversation View -->
            <div x-show="currentView === 'conversation'" class="h-full flex flex-col">
    ...
    <!-- Toast Notification (ketika widget collapsed) -->
    <div x-show="showToast && !isExpanded" 
