                        ...
                        <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-blue-700">
                                    ...
                                    <p>• Success Rate akan dihitung otomatis berdasarkan Total Orders dan Orders Sukses</p>
                                    <p>• Risk Level akan ditentukan otomatis berdasarkan Success Rate (≥80% = Low Risk, 60-79% = Medium Risk, <60% = High Risk)</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                if (totalOrders === 0) {
                    previewDiv.innerHTML = '<p>Masukkan data order untuk melihat preview kalkulasi success rate dan risk level.</p>';
                    return;
                }
