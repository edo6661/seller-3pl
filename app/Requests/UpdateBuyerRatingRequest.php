...
class UpdateBuyerRatingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_orders' => 'sometimes|required|integer|min:0',
            'successful_orders' => 'sometimes|required|integer|min:0',
            'failed_cod_orders' => 'sometimes|required|integer|min:0',
            'cancelled_orders' => 'sometimes|required|integer|min:0',
            'success_rate' => 'sometimes|required|numeric|between:0,100',
